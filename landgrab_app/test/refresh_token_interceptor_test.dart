...
void main() {
  ...
  test('concurrent 401s share a single renewal', () async {
    ...
    adapter.onGet('/landgrab/event', (s) => s.reply(401, {'error': 'unauthorized'}));
    adapter.onGet('/landgrab/poles', (s) => s.reply(401, {'error': 'unauthorized'}));

    postRenewalAdapter.onGet('/landgrab/event', (s) => s.reply(200, {'ok': 'event'}));
    postRenewalAdapter.onGet('/landgrab/poles', (s) => s.reply(200, {'ok': 'poles'}));
