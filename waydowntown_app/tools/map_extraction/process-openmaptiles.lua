-- Adapted from https://github.com/systemed/tilemaker/blob/eab08d189ad97ddf5db7d915bcabe42ad3dab6af/resources/process-openmaptiles.lua
...
function way_function()
  ...
  elseif waterway == "boatyard" then
    Layer("landuse", is_closed); Attribute("class", "industrial"); MinZoom(12)
  elseif waterway == "dam" then
    Layer("building", is_closed)
  elseif waterway == "fuel" then
    Layer("landuse", is_closed); Attribute("class", "industrial"); MinZoom(14)
  end
  -- Set names on rivers
  if waterwayClasses[waterway] and not is_closed then
    if waterway == "river" and Holds("name") then
  ...
  if boundary == "national_park" then
    Layer("park", true); Attribute("class", boundary); SetNameAttributes()
  elseif leisure == "nature_reserve" then
    Layer("park", true); Attribute("class", leisure); SetNameAttributes()
  end
