defmodule Mix.Tasks.Poles.FetchRivers do
  @moduledoc """
  ...
  `lib/registrations_web/templates/page/poles.html.heex` at render time
  so the placeholder is a static fetch with no runtime network call.

      mix poles.fetch_rivers
  ...
  @viewbox_width 800
  @viewbox_height 500
  @output_path "priv/poles/rivers.json"
