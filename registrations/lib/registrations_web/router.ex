defmodule RegistrationsWeb.Router do
  ...
  scope "/landgrab", RegistrationsWeb.Landgrab, as: :landgrab do
    ...
    post("/notifications/:id/respond", NotificationController, :respond)
  ...
  scope "/landgrab/supervision", RegistrationsWeb.Landgrab, as: :landgrab_supervision do
    ...
    post("/endgame/shift", EndgameController, :shift)
    ...
    post("/liberation/teams/:team_id/join", LiberationController, :join_team)
    ...
    post("/acceptances", SupervisionController, :bulk_accept)
    post("/statuses", SupervisionController, :bulk_set_status)
