# Rust API for waydowntown-server
...
- API version: 1.0.0
- Build date: 2024-08-17T11:31:42.596392-05:00[America/Winnipeg]
- Generator version: 7.7.0



This autogenerated project defines an API crate `waydowntown-server` which contains:
...
#[async_trait]
impl waydowntown-server::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = waydowntown-server::server::new(Arc::new(ServerImpl));
